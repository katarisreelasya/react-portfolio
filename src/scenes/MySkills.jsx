    ...
    <section id="skills" className="pt-0 pb-24">
      ...
      <div className="md:flex md:justify-between md:gap-16 mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7">
            A Grad with Web development and Cyber, Machine Learning, coupled with a passion for coding,
        ...
        <div className="mt-16 md:mt-0">
          {isAboveMediumScreens ? (
            ...
            >
              <img
                className="z-10 h-60 w-60 max-w-[400px] md:max-w-[600px]"
                alt="skills"
                src={require("../assets/skill.jpeg")}
              />
            </div>
          ) : (
            <img
      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        >
          ...
          <p className="mt-5">
            <span className="font-playfair font-semibold text-xl mt-3">
              CTTC Bhubaneswar Intern | Tata Consultancy Services Intern(Cyber)
            </span>
        ...
        >
          ...
          <p className="mt-5">
            <span className="font-playfair font-semibold text-xl mt-3">
              HTML, ReactJS, MongoDB, MySQL,Express, Node.js, Vite.
            </span>
